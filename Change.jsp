...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="frm" method="post" action="Change" onsubmit="return validate(this);">
		<!-- start content -->
		<div id="content">
			<div class="flower"><center><h1>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Change User Credential<h1></div>
			<br/>
			<%
	...
	out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
		...
		out.println("<center><font size=3 color=red>"+res+"</font></center>");
			...
			<table align="right">
<tr><td><b>User Role</b></td><td><select name="t1">
<%try{
			  Connection con = Database.getCon();
			  Statement stmt = con.createStatement();
			ResultSet rs = stmt.executeQuery("select role from acp");
			while(rs.next()){%>
...
<tr><td></td><td><input type="submit" value="Change"></td>
</td></tr></table>
</form>
			</table>
