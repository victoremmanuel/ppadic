...
<div id="header">
	...
	<div id="menu">
		<li><a href="AddPrescription.jsp">Add Prescription</a></li><td></td>
			<li><a href="ViewPrescription.jsp">View Prescription</a></li><td></td>
...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="frm" method="post" action="AddPrescription" onsubmit="return validate(this);">
		<!-- start content -->
		<div id="content">
...
<tr><td><b>Problem</b></td><td><textarea rows="6" cols="26" name="t3"></textarea> </td></tr>
<tr><td><b>Prescription</b></td><td><textarea rows="6" cols="26" name="t4"></textarea> </td></tr>
<tr><td></td><td><input type="submit" value="Add Prescription"></td>
</td></tr></table>
</form>
			</table>
