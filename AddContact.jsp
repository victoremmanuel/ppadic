...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="frm" method="post" action="AddContact" onsubmit="return validate(this);">
		<!-- start content -->
		<div id="content">
			<div class="flower"><center><h1>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Screen To Add Contact Information<h1></div>
			<br/>
			<%
...
<tr><td><b>Problem Description</b></td><td><textarea rows="6" cols="26" name="t3"></textarea> </td></tr>
<tr><td><b>contact No</b></td><td><input type="text" name="t4"/> </td></tr>
<tr><td><b>Address</b></td><td><input type="text" name="t5"/> </td></tr>

<tr><td></td><td><input type="submit" value="Add Patient"></td>
</td></tr></table>
</form>
			</table>
